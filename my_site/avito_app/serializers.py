...
class CategoryDetailSerializer(serializers.ModelSerializer):
    sub_category = SubCategorySimpleSerializer(many=True,read_only=True)
    class Meta:
        model = Category
        fields = ['category_name', 'category_image', 'sub_category']
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'subcategory', 'product_name',  'product_img', 'get_avg_rating', 'get_count_rating',
                  'price']
...
class SubCategoryDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubCategory
        fields = ['sub_category_name', 'sub_category_image', 'sub_product']
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ['review_image','comment','rating','created_time',"user"]
